      ...
      <main className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed text-gray-600">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>Titular:</strong> José Luis Ureña (en adelante, el prestador)</li>
            <li><strong>Correo electrónico de contacto:</strong> auraonlinebox@gmail.com</li>
            <li><strong>NIF/CIF:</strong> Pendiente de alta como autónomo</li>
          </ul>
          <p>El prestador se encuentra en proceso de alta como trabajador autónomo. Mientras tanto, esta web opera como proyecto en fase de lanzamiento.</p>
          ...
          <p>Todos los contenidos de esta web (textos, logotipos, diseño, imágenes, código fuente) son propiedad del prestador, salvo que se indique lo contrario. Queda prohibida la reproducción, distribución o modificación sin autorización expresa.</p>

          <h2 className="text-lg font-bold text-gray-900 mt-8">4. Exención de responsabilidad</h2>
          <p>El prestador no se hace responsable de los daños o perjuicios que pudieran derivarse del uso incorrecto de esta web o de los servicios ofrecidos. Tampoco se responsabiliza de los contenidos enlazados a través de redes sociales u otros servicios externos.</p>
